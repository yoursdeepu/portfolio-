      ...
      <div className='container mx-auto h-full'>
        <div className='flex items-center h-full pt-8'>
          ...
          <div className='flex-1 flex flex-col items-center lg:items-start'>
            <p className='text-lg text-accent mb-[22px]'>Hey, I'm Deepesh &#x1F44B;</p>
            ...
            <p className='pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left'>Designing success, through creative web design
            </p>
